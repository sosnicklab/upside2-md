...
# MARTINI 3.0 1UBQ Simulation Workflow (CHARMM-GUI Protocol)
...
#   PDB_ID                - PDB identifier (default: 1ubq)
...
# Default to 1ubq if not specified
PDB_ID="${PDB_ID:-1ubq}"
...
SEED=12345
MIN_MAX_ITER="${MIN_MAX_ITER:-3000}"
MIN_STEP="${MIN_STEP:-0.01}"
...
echo "=== MARTINI 3.0 1UBQ Workflow (CHARMM-GUI Protocol) ==="
echo "PDB ID: $PDB_ID"
...
export UPSIDE_NPT_COMPRESSIBILITY=${UPSIDE_NPT_COMPRESSIBILITY:-2.1782}
export UPSIDE_NPT_SEMI=${UPSIDE_NPT_SEMI:-0}
