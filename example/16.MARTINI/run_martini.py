...
# --- SKIP MINIMIZATION: Use centered initial positions for MD ---
...
with tb.open_file(input_file, 'w') as t:
    ...
    mass = np.ones(n_atoms, dtype='f4') * 72.0  # MARTINI standard mass
    ...
    martini_group._v_attrs.debug_mode = 1  # Enable debug mode to print forces
...
print(f"Created input with {len(pairs_list)} LJ pairs for MD (minimization skipped)")
