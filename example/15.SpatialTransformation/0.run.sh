...
kwargs="$kwargs --spatial-transform-from-table=spatial_table"
...
echo "Running..."
# run simulation
$upside --frame-interval $frame_interval --temperature $T --duration $duration --seed $seed $h5_file --disable-recentering | tee $log_file
