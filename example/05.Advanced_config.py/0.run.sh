...
kwargs="--config=$config_base"
kwargs="$kwargs --restraint-group=0-9"
kwargs="$kwargs --restraint-spring-constant=2.0"

echo "Advanced Config commandline options:"
echo $UPSIDE_HOME/py/advanced_config.py $kwargs

$UPSIDE_HOME/py/advanced_config.py $kwargs
